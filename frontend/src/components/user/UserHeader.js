  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        console.log('UserHeader - Current user data:', currentUser);
        setUser(currentUser);
      } catch (error) {
    ...
    <Header>
      <HeaderContent>
        ...
        <Nav>
          <NavLink 
            to="/user" 
            className={isActive('/user') && location.pathname === '/user' ? 'active' : ''}
          >
            Home
          </NavLink>
          <NavLink 
            to="/user/search" 
            className={isActive('/user/search') ? 'active' : ''}
          >
            Search
          </NavLink>
          <NavLink 
            to="/user/favourites" 
            className={isActive('/user/favourites') ? 'active' : ''}
          >
            Favourites
          </NavLink>
          <NavLink 
          ...
          <NavLink 
            to="/user/account" 
            className={isActive('/user/account') ? 'active' : ''}
          >
            Account
          </NavLink>
        </Nav>
        <UserMenu className="user-menu">
          ...
          <UserDropdown isOpen={dropdownOpen}>
            ...
            <DropdownItem as={Link} to="/user/account" onClick={() => setDropdownOpen(false)}>
